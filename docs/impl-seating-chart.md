...
- **Git 저장소가 아님**. 각 태스크의 "체크포인트"는 (1) 브라우저에서 정의된 동작을 확인하고 (2) `seating-chart/history_seating-chart.md`에 1~2줄로 진척 기록을 남기는 것으로 갈음한다.
...
| `seating-chart/history_seating-chart.md` | 작업 진척 메모. 각 태스크 체크포인트마다 1~2줄 추가. |
...
- Create: `seating-chart/history_seating-chart.md`
...
`seating-chart/history_seating-chart.md` 파일을 다음 내용으로 생성한다:
...
- Modify: `seating-chart/history_seating-chart.md`
...
`history_seating-chart.md` 끝에 추가:
